            ...
            foreach (var targetType in validTargets)
            {
                switch (targetType)
                {
                    case SpellValidTargets.AllyChampions:
                        ...
                        allTargets.AddRange(ObjectManager.Get<AIHeroClient>().Where(ally => ally.IsValidTarget(range, false) && !ally.IsMe && ally.IsAlly).Cast<Obj_AI_Base>());
                        break;
                    ...
                    case SpellValidTargets.EnemyChampions:
                        allTargets.AddRange(ObjectManager.Get<AIHeroClient>().Where(enemy => enemy.IsValidTarget(range)));
